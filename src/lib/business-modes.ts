...
export const MODES: ModeConfig[] = [
  {
    ...
    label: 'Butik Satıcı',
    icon: 'ShoppingBag',
    primaryTools: ['templates', 'editor', 'image', 'tools', 'document', 'banner', 'collage', 'batch'],
  ...
  },
  {
    ...
    icon: 'Store',
    primaryTools: ['templates', 'orders', 'batch', 'editor', 'image', 'tools', 'document'],
  ...
  },
  {
    ...
    label: 'Kişisel & Genel',
    icon: 'Home',
    primaryTools: ['templates', 'editor', 'image', 'tools', 'document', 'banner', 'collage', 'orders'],
  ...
  },
  {
    ...
    icon: 'LayoutGrid',
    primaryTools: ['templates', 'editor', 'image', 'tools', 'document', 'banner', 'collage', 'batch', 'orders', 'pos', 'service', 'appointments'],
    templatePack: [],
