...
export const BIP39_WORDLIST: string[] = [
  ...
  'online','only','onto','open','opera','opinion','oppose','option','orange','orbit',
  ...
  'pill','pilot','pin','pine','pipe','pistol','pitch','pizza','place','planet',
  ...
  'spread','spring','spy','squad','square','squat','staff','stage','stain','stairs',
