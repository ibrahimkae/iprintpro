                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Kaydedilen taslaklar ve çıktılar</div>
                    </div>
                  </div>
                  <ChevronRight size={14} className="text-slate-400 dark:text-slate-500 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors" />
                </button>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Koyuluk, dithering, kağıt tipi</div>
                    </div>
                  </div>
                  <ChevronRight size={14} className="text-slate-400 dark:text-slate-500 group-hover:text-teal-500 dark:group-hover:text-teal-400 transition-colors" />
                </button>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Hız testi, karakter seti kontrolü</div>
                    </div>
                  </div>
                  <ChevronRight size={14} className="text-slate-400 dark:text-slate-500 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors" />
                </button>
              </div>

              {/* SECTION: Preferences */}
              <div className="space-y-2 mb-4">
                <div className="px-2 pb-0.5 text-[10px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-500">
                  Görünüm & Sistem
                </div>

                {/* Dark Mode Toggle */}
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-amber-50 dark:bg-amber-950/60 text-amber-500 dark:text-amber-400 border border-amber-100/60 dark:border-amber-900/60">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Göz yormayan karanlık mod</div>
                    </div>
                  </div>
                  <Switch 
                    checked={isDarkMode} 
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 hover:bg-blue-50/50 dark:hover:bg-blue-950/30 text-slate-800 dark:text-slate-200 transition-colors group cursor-pointer text-left"
                >
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-100/60 dark:border-blue-900/60">
                      <Globe size={16} />
                    </div>
                    <div>
                      <div className="text-xs font-bold leading-tight">Uygulama Dili</div>
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Türkçe / English</div>
                    </div>
                  </div>
                  <span className="text-[11px] font-black bg-blue-100 dark:bg-blue-950/80 text-blue-700 dark:text-blue-300 border border-blue-200/50 dark:border-blue-800 px-2 py-0.5 rounded-md">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200/60 dark:border-slate-700/60">
                      <Terminal size={16} />
                    </div>
                    <div>
                      <div className="text-xs font-bold text-slate-800 dark:text-slate-200">Hata Konsolu</div>
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">Canlı log ve BLE bildirimleri</div>
                    </div>
                  </div>
                  <Switch 
                    checked={showConsole} 
